...
cube_noise =   #insert mad_std value of cube here
...
dend = astrodendro.Dendrogram.compute(sub_cube.unmasked_data[:].value, 
                                      wcs = cube.wcs,
...
dend.save_to(path+'CS_HVCC_dendrogram_mv_'+str(min_val)+'_ms_'+str(min_sig)+'_mp_'+str(mpix)+'.fits')